<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="nav-item"><a href="/profile" class="nav-link">Dashboard</a></li>
    <li class="nav-item"><a href="/list-books" class="nav-link">Books List</a></li>
    <li class="nav-item"><a href="/logout" class="btn btn-outline-danger me-2">Log out</a></li>
    @endif
  </ul>
</header>